    ...
    return (
        <div className="loader">
            <div className="truckWrapper">
                ...
                {/* 修改后的 SVG：移除 xml:space 和 xmlns:xlink */}
                <svg viewBox="0 0 453.459 453.459" xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1" fill="#000000" className="lampPost">
                    <path
