...
// 动画函数，负责持续更新并绘制烟花和粒子
function animate (ctx, canvas, fireworks, particles) {
    ...
    // 请求下一帧继续动画
    requestAnimationFrame(() => animate(ctx, canvas, fireworks, particles));
};


export { Firework, Particle , resizeCanvas, animate };